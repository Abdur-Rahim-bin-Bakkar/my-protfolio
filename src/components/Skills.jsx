...
const Skills = () => {
  const frontendSkills = [
    ...
    { name: 'Hero UI', level: 'Intermediate' },
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8">
              {[
                { name: "REST API", level: "Daily Use" },
                { name: "Figma", level: "Design Handoff" },
                { name: "Git", level: "Version Control" },
                { name: "GitHub", level: "Repo Management" },
                { name: "VS Code", level: "Primary Editor" },
              ].map((tool) => (
                <div key={tool.name} className="flex items-center gap-4 group/item">
                  <div className="text-blue-500 bg-blue-500/10 p-2 rounded-lg group-hover/item:bg-blue-500 group-hover/item:text-white transition-all">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" />
                    </svg>
                  </div>
