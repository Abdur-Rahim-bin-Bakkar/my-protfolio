...
const Footer = () => {
  return (
    <footer className="bg-background border-t border-gray-200 dark:border-gray-800 py-16 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        <motion.div 
          ...
          className="space-y-4"
        >
          <h2 className="text-2xl font-bold tracking-tight text-text-primary">Jensen <span className="text-brand-orange">Omega</span></h2>
        ...
        >
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-text-secondary hover:bg-brand-orange hover:text-white transition-all shadow-sm">
      ...
      <div className="max-w-7xl mx-auto pt-16 mt-16 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center text-text-muted text-xs gap-4">
        <p>© 2024 Jensen Omega. All rights reserved.</p>
        <div className="flex gap-8">
          <a href="#" className="hover:text-brand-orange dark:hover:text-text-primary transition-colors">Privacy Policy</a>
          <a href="#" className="hover:text-brand-orange dark:hover:text-text-primary transition-colors">Terms of Service</a>
        </div>
      </div>
    </footer>
  );
